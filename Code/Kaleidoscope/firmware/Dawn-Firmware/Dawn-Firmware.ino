...
// Support for disabling LEDs after keyboard inactivity
...
void toggleLedsOnSuspendResume(kaleidoscope::plugin::HostPowerManagement::Event event) {
  ...
  case kaleidoscope::plugin::HostPowerManagement::Resume:
    LEDControl.enable();
    LEDRainbowSwoopEffect.activate();
    break;
...
KALEIDOSCOPE_INIT_PLUGINS(
  ...
  LEDRainbowSwoopEffect,

  // Let us turn off all the LEDs.
  LEDOff,
...
void setup() {
  ...
  PersistentIdleLEDs.setIdleTimeoutSeconds(120); // 2 min
  LEDRainbowSwoopEffect.activate();
